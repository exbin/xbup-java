 ...
 */
public class CatalogSearchManagerPanel extends javax.swing.JPanel implements ActivePanelActionHandling {

    private XBACatalog catalog = null;
    private final CatalogItemsSearchPanel catalogItemSearchPanel = new CatalogItemsSearchPanel();

    public CatalogSearchManagerPanel() {
        initComponents();
        add(catalogItemSearchPanel, "catalog");
    }
    ...
    public void setCatalog(XBACatalog catalog) {
        if (catalog == null) {
            ...
            catalogItemSearchPanel.setCatalog(catalog);
    ...
    public boolean updateActionStatus(Component component) {
        return catalogItemSearchPanel.updateActionStatus(component);
    }

    @Override
    public void releaseActionStatus() {
        catalogItemSearchPanel.releaseActionStatus();
    }

    @Override
    public boolean performAction(String eventName, ActionEvent event) {
        return catalogItemSearchPanel.performAction(eventName, event);
    }

    public void setMainFrameManagement(MainFrameManagement mainFrameManagement) {
        catalogItemSearchPanel.setMainFrameManagement(mainFrameManagement);
    }

    public void setMenuManagement(MenuManagement menuManagement) {
        catalogItemSearchPanel.setMenuManagement(menuManagement);
    }
}
