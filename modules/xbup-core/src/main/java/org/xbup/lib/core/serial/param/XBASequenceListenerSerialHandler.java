 ...
 */
public class XBASequenceListenerSerialHandler implements XBPSequenceSerialHandler, XBASequenceOutputSerialHandler, XBASerialSequenceable, XBTTokenOutputSerialHandler {
