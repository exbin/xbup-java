...
/**
 * XBUP level 1 serialization method using XBTListener.
 *
 * @version 0.1 wr23.0 2014/03/08
 * @author XBUP Project (http://xbup.org)
 */
public class XBTListenerSerialMethod implements XBSerialMethod {
    
    private int methodIndex = 0;

    public XBTListenerSerialMethod() {
    }

    public XBTListenerSerialMethod(int methodIndex) {
        this();
    ...
    public Class<? extends XBSerialHandler> getHandlerClass() {
        return XBTListenerSerialHandler.class;
    }
}
