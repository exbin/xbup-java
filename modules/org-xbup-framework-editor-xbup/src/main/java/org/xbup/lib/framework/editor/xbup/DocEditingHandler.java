...
public class DocEditingHandler {
    ...
    public void init() {
        ...
        // addItemAction.putValue(Action.ACCELERATOR_KEY, javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F, metaMask));
        ...
        // modifyItemAction.putValue(Action.ACCELERATOR_KEY, javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F3, 0));
        addItemAction.putValue(ActionUtils.ACTION_DIALOG_MODE, true);
    }
