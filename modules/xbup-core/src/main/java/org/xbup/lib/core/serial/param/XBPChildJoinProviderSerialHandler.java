 ...
 */
public class XBPChildJoinProviderSerialHandler implements XBPChildInputSerialHandler, XBTTokenInputSerialHandler {

    private XBTPullPreLoader pullProvider;
    private XBChildSerialState state;
    private XBTReadSerialHandler childHandler = null;

    public XBPChildJoinProviderSerialHandler() {
        state = XBChildSerialState.BLOCK_BEGIN;
    }

    public XBPChildJoinProviderSerialHandler(XBTReadSerialHandler childHandler) {
        this();
