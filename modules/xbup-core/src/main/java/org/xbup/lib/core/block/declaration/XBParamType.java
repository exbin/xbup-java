...
public enum XBParamType {
    ...
    CONSIST,
    /** Append attributes and subblocks of given block or single attribute if unspecified. */
    JOIN,
    /** List of given block starting with count of blocks as UBENatural (including infinity). */
    LIST_CONSIST,
    /** Append finite list of attributes and subblocks of given block type or list of attributes. */
    LIST_JOIN
