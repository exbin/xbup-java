...
import org.xbup.lib.xb.serial.basic.*;
 ...
 */
public class XBEventListenerSerialMethod implements XBSerialMethod {
    
    private int methodIndex = 0;

    public XBEventListenerSerialMethod() {
    }

    public XBEventListenerSerialMethod(int methodIndex) {
        this();
