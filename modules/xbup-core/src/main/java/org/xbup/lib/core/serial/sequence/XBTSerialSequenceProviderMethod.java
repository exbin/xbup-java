 ...
 */
public class XBTSerialSequenceProviderMethod implements XBSerialMethod {

    private int methodIndex = 0;

    public XBTSerialSequenceProviderMethod() {
    }

    public XBTSerialSequenceProviderMethod(int methodIndex) {
        this();
    ...
    public Class<? extends XBSerialHandler> getHandlerClass() {
        return XBTSerialSequenceProviderHandler.class;
    }
}
