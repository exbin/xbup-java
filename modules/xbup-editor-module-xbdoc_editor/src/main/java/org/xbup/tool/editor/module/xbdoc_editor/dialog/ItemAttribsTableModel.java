...
import org.xbup.lib.core.catalog.declaration.XBCPSpecDecl;
...
public class ItemAttribsTableModel extends AbstractTableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if (rowIndex<2) {
            switch(columnIndex) {
                case 0: return "UBNatural";
                case 1: if (rowIndex==0) {
                    return "BlockGroup";
                } else {
                return "BlockType";
            }
                case 2:  if (rowIndex==0) {
        ...
        } else if (getTypeSpec()!=null) {
            if (attrList.size()<=(rowIndex-2)) {
                switch(columnIndex) {
                    case 0: return "UBNumber";
                    case 1: return "attribute";
                    case 2: return "Attribut out of range";
                    default: throw new IllegalArgumentException();
                }
            } else {
//                XBAttributeType attrib = attrList.get(rowIndex-2);
//                if (attrib!=null) {
/*                    switch(columnIndex) {
                        case 0: {
                            if (typeSpec.getXbCatalog()!=null) return typeSpec.getXbCatalog().getItemManager().getName(attrib.getUsedBy());
                            return "";
                        }
                        case 1: {
                            if (typeSpec.getXbCatalog()!=null)  return typeSpec.getXbCatalog().getItemManager().getName(attrib);
                            return "";
                        }
                        case 2: {
                            if (typeSpec.getXbCatalog()!=null)  return typeSpec.getXbCatalog().getItemManager().getDesc(attrib);
                            return "";
                        }
                        default: throw new IllegalArgumentException();
                    } */
...
//                } else {
                    switch(columnIndex) {
                        case 0: return "UBNumber";
                        case 1: return "attribute";
                        case 2: return "missing specification";
                        default: throw new IllegalArgumentException();
                    }
//                }
            }
...
/*        if (getTypeSpec()!=null) {
    ...
    public XBCPSpecDecl getTypeSpec() {
        return typeSpec;
    }

    public void setTypeSpec(XBCPSpecDecl typeSpec) {
