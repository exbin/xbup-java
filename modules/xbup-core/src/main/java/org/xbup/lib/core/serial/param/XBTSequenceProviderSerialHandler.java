 ...
 */
public class XBTSequenceProviderSerialHandler implements XBTSequenceSerialHandler, XBTSequenceInputSerialHandler, XBPSerialSequenceable, XBTTokenInputSerialHandler {
