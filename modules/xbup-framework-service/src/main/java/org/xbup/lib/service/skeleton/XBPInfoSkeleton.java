...
public class XBPInfoSkeleton {
    ...
    public void registerProcedures(XBRemoteServer remoteServer) {
        ...
        remoteServer.addXBProcedure(new XBDeclBlockType(new XBLBlockDecl(XBServiceClient.INFOSCOUNT_INFO_PROCEDURE)), new XBProcedure() {
        ...
        remoteServer.addXBProcedure(new XBDeclBlockType(new XBLBlockDecl(XBServiceClient.FILENAME_INFO_PROCEDURE)), new XBProcedure() {
        ...
        remoteServer.addXBProcedure(new XBDeclBlockType(new XBLBlockDecl(XBServiceClient.PATH_INFO_PROCEDURE)), new XBProcedure() {
