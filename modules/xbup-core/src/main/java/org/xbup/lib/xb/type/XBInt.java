...
import org.xbup.lib.xb.ubnumber.type.UBInt32;
 ...
 */
public class XBInt implements XBSerializable, XBDeclared {

    private UBInteger value;
    private UBNatural bitSize;
    public static long[] xbBlockPath = {1, 1, 1, 1}; // Testing only
