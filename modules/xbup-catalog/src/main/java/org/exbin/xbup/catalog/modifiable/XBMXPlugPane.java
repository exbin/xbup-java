...
public interface XBMXPlugPane extends XBCXPlugPane, XBMBase {
    ...
    /**
     * Sets index of the panel editor.
     *
     * @param paneIndex panel editor index
     */
    void setPaneIndex(long paneIndex);
}
