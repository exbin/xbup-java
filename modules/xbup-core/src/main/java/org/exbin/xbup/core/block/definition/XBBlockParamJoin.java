...
/**
 * XBUP level 1 block join parameter.
 *
 * @author ExBin Project (https://exbin.org)
 */
public class XBBlockParamJoin implements XBBlockParam, XBPSequenceSerializable, XBTBasicReceivingSerializable {

    private XBBlockDecl blockDecl;

    public XBBlockParamJoin() {
        blockDecl = new XBLBlockDecl();
    }

    public XBBlockParamJoin(XBBlockDecl blockDecl) {
    ...
    public void serializeXB(XBPSequenceSerialHandler serial) throws XBProcessingException, IOException {
        serial.begin();
        serial.matchType(new XBFixedBlockType(XBBasicBlockType.BLOCK_JOIN_PARAMETER));
