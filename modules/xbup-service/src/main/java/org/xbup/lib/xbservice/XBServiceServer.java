 ...
 */
package org.xbup.lib.xbservice;
...
import org.xbup.lib.xb.catalog.base.XBCXItemInfo;
import org.xbup.lib.xb.catalog.base.XBCJoinDef;
...
import org.xbup.lib.xb.catalog.base.service.XBCXInfoService;
...
import org.xbup.lib.xb.catalog.base.service.XBCXLineService;
import org.xbup.lib.xb.catalog.base.service.XBCXNameService;
import org.xbup.lib.xb.catalog.base.service.XBCXPaneService;
import org.xbup.lib.xb.catalog.base.service.XBCXPlugService;
...
import org.xbup.lib.xb.remote.XBProcedure;
import org.xbup.lib.xb.remote.XBServiceClient;
import org.xbup.lib.xb.remote.XBTCPRemoteServer;
...
import org.xbup.lib.xbcatalog.entity.XBEBlockListCons;
import org.xbup.lib.xbcatalog.entity.XBEBlockListJoin;
...
import org.xbup.lib.xbcatalog.entity.XBERev;
import org.xbup.lib.xbcatalog.entity.XBESpec;
import org.xbup.lib.xbcatalog.entity.XBESpecDef;
import org.xbup.lib.xbcatalog.entity.XBEXBlockLine;
...
import org.xbup.lib.xbcatalog.entity.XBEXPlugLine;
import org.xbup.lib.xbcatalog.entity.XBEXPlugPane;
import org.xbup.lib.xbcatalog.entity.XBEXPlugin;
import org.xbup.lib.xbcatalog.entity.XBEXStri;
import org.xbup.lib.xbcatalog.entity.service.XBEItemService;
import org.xbup.lib.xbcatalog.entity.service.XBENodeService;
import org.xbup.lib.xbcatalog.entity.service.XBERevService;
import org.xbup.lib.xbcatalog.entity.service.XBESpecService;
import org.xbup.lib.xbcatalog.entity.service.XBEXDescService;
import org.xbup.lib.xbcatalog.entity.service.XBEXFileService;
import org.xbup.lib.xbcatalog.entity.service.XBEXInfoService;
import org.xbup.lib.xbcatalog.entity.service.XBEXLangService;
import org.xbup.lib.xbcatalog.entity.service.XBEXNameService;
import org.xbup.lib.xbcatalog.entity.service.XBEXStriService;
...
*/
    ...
    private class StopServiceProcedure implements XBProcedure {
        ...
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.STOP_SERVICE_PROCEDURE));
        }
    ...
    private class PingServiceProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PING_SERVICE_PROCEDURE));
        }
    ...
    private class LoginServiceProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LOGIN_SERVICE_PROCEDURE));
        }
...
//            source.endXBT();
    ...
    private class VersionInfoProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.VERSION_INFO_PROCEDURE));
        }
    ...
    private class OwnerItemProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.OWNER_ITEM_PROCEDURE));
        }
    ...
    private class XBIndexItemProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.XBINDEX_ITEM_PROCEDURE));
        }
    ...
    private class ItemsCountItemProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEMSCOUNT_ITEM_PROCEDURE));
        }
    ...
    private class RootNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ROOT_NODE_PROCEDURE));
        }
    ...
    private class RootProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ROOT_PROCEDURE));
        }
    ...
    private class SubNodeNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.SUBNODE_NODE_PROCEDURE));
        }
    ...
    private class SubNodesNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.SUBNODES_NODE_PROCEDURE));
        }
    ...
    private class SubNodesCountNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.SUBNODESCOUNT_NODE_PROCEDURE));
        }
    ...
    private class SpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.SPEC_NODE_PROCEDURE));
        }
    ...
    private class SpecsNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.SPECS_NODE_PROCEDURE));
        }
    ...
    private class FormatSpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FORMATSPEC_NODE_PROCEDURE));
        }
    ...
    private class FormatSpecsNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FORMATSPECS_NODE_PROCEDURE));
        }
    ...
    private class GroupSpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.GROUPSPEC_NODE_PROCEDURE));
        }
    ...
    private class GroupSpecsNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.GROUPSPECS_NODE_PROCEDURE));
        }
    ...
    private class BlockSpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.BLOCKSPEC_NODE_PROCEDURE));
        }
    ...
    private class BlockSpecsNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.BLOCKSPECS_NODE_PROCEDURE));
        }
    ...
    private class FindOwnerNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FINDOWNER_NODE_PROCEDURE));
        }
    ...
    private class PathNodeNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PATHNODE_NODE_PROCEDURE));
        }
    ...
    private class FindNodeNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FINDNODE_NODE_PROCEDURE));
        }
    ...
    private class MaxSubNodeNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.MAXSUBNODE_NODE_PROCEDURE));
        }
    ...
    private class FindBlockSpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FINDBLOCKSPEC_NODE_PROCEDURE));
        }
    ...
    private class MaxBlockSpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.MAXBLOCKSPEC_NODE_PROCEDURE));
        }
    ...
    private class FindGroupSpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FINDGROUPSPEC_NODE_PROCEDURE));
        }
    ...
    private class MaxGroupSpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.MAXGROUPSPEC_NODE_PROCEDURE));
        }
    ...
    private class FindFormatSpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FINDFORMATSPEC_NODE_PROCEDURE));
        }
    ...
    private class MaxFormatSpecNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.MAXFORMATSPEC_NODE_PROCEDURE));
        }
    ...
    private class SpecsCountNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.SPECSCOUNT_NODE_PROCEDURE));
        }
    ...
    private class BlockSpecsCountNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.BLOCKSPECSCOUNT_NODE_PROCEDURE));
        }
    ...
    private class GroupSpecsCountNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.GROUPSPECSCOUNT_NODE_PROCEDURE));
        }
    ...
    private class FormatSpecsCountNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FORMATSPECSCOUNT_NODE_PROCEDURE));
        }
    ...
    private class NodesCountNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.NODESCOUNT_NODE_PROCEDURE));
        }
    ...
    private class SubNodeSeqNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.SUBNODESEQ_NODE_PROCEDURE));
        }
    ...
    private class SubNodesSeqCountNodeProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.SUBNODESEQCNT_NODE_PROCEDURE));
        }
    ...
    private class BindSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.BIND_SPEC_PROCEDURE));
        }
    ...
    private class BindsSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.BINDS_SPEC_PROCEDURE));
        }
    ...
    private class BindsCountSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.BINDSCOUNT_SPEC_PROCEDURE));
        }
    ...
    private class FindBindSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FINDBIND_SPEC_PROCEDURE));
        }
    ...
    private class FindRevSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FINDREV_SPEC_PROCEDURE));
        }
    ...
    private class FormatSpecsCountSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FORMATSPECSCOUNT_SPEC_PROCEDURE));
        }
    ...
    private class GroupSpecsCountSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.GROUPSPECSCOUNT_SPEC_PROCEDURE));
        }
    ...
    private class BlockSpecsCountSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.BLOCKSPECSCOUNT_SPEC_PROCEDURE));
        }
    ...
    private class SpecsCountSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.SPECSCOUNT_SPEC_PROCEDURE));
        }
...
/*                        case XBLIMIT: {
    ...
    private class RevsCountSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.REVSCOUNT_SPEC_PROCEDURE));
        }
    ...
    private class RevSpecProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.REV_SPEC_PROCEDURE));
        }
    ...
    private class TargetBindProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.TARGET_BIND_PROCEDURE));
        }
    ...
    private class BindsCountBindProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.BINDSCOUNT_BIND_PROCEDURE));
        }
    ...
    private class XBLimitRevProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.XBLIMIT_REV_PROCEDURE));
        }
    ...
    private class RevsCountRevProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.REVSCOUNT_REV_PROCEDURE));
        }
    ...
    private class CodeLangProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.CODE_LANG_PROCEDURE));
        }
        ...
        public void execute(XBTStreamChecker source, XBTListener result) throws XBProcessingException, IOException {
            ...
            text.serializeXB(XBSerializationType.TO_XB, 1, handler);
//                            new XBL1ToL0StreamConvertor.XBCL1ToL0DefaultStreamConvertor((XBCL1Streamable) new XBL2ToL1StreamConvertor.XBCL2ToL1DefaultStreamConvertor(text)).writeXBStream(output);
    ...
    private class DefaultLangProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.DEFAULT_LANG_PROCEDURE));
        }
    ...
    private class LangsLangProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LANGS_LANG_PROCEDURE));
        }
    ...
    private class LangsCountLangProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LANGSCOUNT_LANG_PROCEDURE));
        }
    ...
    private class ItemNameProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEM_NAME_PROCEDURE));
        }
    ...
    private class TextNameProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.TEXT_NAME_PROCEDURE));
        }
...
//                            new XBL1ToL0StreamConvertor.XBCL1ToL0DefaultStreamConvertor((XBCL1Streamable) new XBL2ToL1StreamConvertor.XBCL2ToL1DefaultStreamConvertor(text)).writeXBStream(output);
    ...
    private class LangNameProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LANG_NAME_PROCEDURE));
        }
    ...
    private class ItemNameNameProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEMNAME_NAME_PROCEDURE));
        }
    ...
    private class LangNameNameProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LANGNAME_NAME_PROCEDURE));
        }
    ...
    private class ItemNamesNameProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEMNAMES_NAME_PROCEDURE));
        }
    ...
    private class NamesCountNameProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.NAMESCOUNT_NAME_PROCEDURE));
        }
    ...
    private class ItemDescProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEM_DESC_PROCEDURE));
        }
    ...
    private class TextDescProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.TEXT_DESC_PROCEDURE));
        }
...
//                            new XBL1ToL0StreamConvertor.XBCL1ToL0DefaultStreamConvertor((XBCL1Streamable) new XBL2ToL1StreamConvertor.XBCL2ToL1DefaultStreamConvertor(text)).writeXBStream(output);
    ...
    private class LangDescProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LANG_DESC_PROCEDURE));
        }
    ...
    private class ItemDescDescProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEMDESC_DESC_PROCEDURE));
        }
    ...
    private class LangNameDescProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LANGNAME_DESC_PROCEDURE));
        }
    ...
    private class ItemDescsDescProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEMDESCS_DESC_PROCEDURE));
        }
    ...
    private class DescsCountDescProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.DESCSCOUNT_DESC_PROCEDURE));
        }
    ...
    private class NodeInfoProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.NODE_INFO_PROCEDURE));
        }
    ...
    private class InfosCountInfoProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.INFOSCOUNT_INFO_PROCEDURE));
        }
    ...
    private class FileNameInfoProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FILENAME_INFO_PROCEDURE));
        }
...
//                            new XBL1ToL0StreamConvertor.XBCL1ToL0DefaultStreamConvertor((XBCL1Streamable) new XBL2ToL1StreamConvertor.XBCL2ToL1DefaultStreamConvertor(text)).writeXBStream(output);
    ...
    private class PathInfoProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PATH_INFO_PROCEDURE));
        }
...
//                            new XBL1ToL0StreamConvertor.XBCL1ToL0DefaultStreamConvertor((XBCL1Streamable) new XBL2ToL1StreamConvertor.XBCL2ToL1DefaultStreamConvertor(text)).writeXBStream(output);
    ...
    private class OwnerFileProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.OWNER_FILE_PROCEDURE));
        }
    ...
    private class FileNameFileProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FILENAME_FILE_PROCEDURE));
        }
...
//                            new XBL1ToL0StreamConvertor.XBCL1ToL0DefaultStreamConvertor((XBCL1Streamable) new XBL2ToL1StreamConvertor.XBCL2ToL1DefaultStreamConvertor(text)).writeXBStream(output);
    ...
    private class DataFileProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.DATA_FILE_PROCEDURE));
        }
    ...
    private class OwnerIconProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.OWNER_ICON_PROCEDURE));
        }
    ...
    private class ModeIconProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.MODE_ICON_PROCEDURE));
        }
    ...
    private class XBIndexIconProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.XBINDEX_ICON_PROCEDURE));
        }
    ...
    private class DefaultItemIconProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.DEFAULTITEM_ICON_PROCEDURE));
        }
    ...
    private class FileIconProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FILE_ICON_PROCEDURE));
        }
    ...
    private class OwnerPluginProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.OWNER_PLUGIN_PROCEDURE));
        }
    ...
    private class FilePluginProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.FILE_PLUGIN_PROCEDURE));
        }
    ...
    private class IndexPluginProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.INDEX_PLUGIN_PROCEDURE));
        }
    ...
    private class LinePluginPluginProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LINEPLUGIN_PLUGIN_PROCEDURE));
        }
    ...
    private class LineIndexPluginProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LINEINDEX_PLUGIN_PROCEDURE));
        }
    ...
    private class PanePluginPluginProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PANEPLUGIN_PLUGIN_PROCEDURE));
        }
    ...
    private class PaneIndexPluginProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PANEINDEX_PLUGIN_PROCEDURE));
        }
    ...
    private class RevLineProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.REV_LINE_PROCEDURE));
        }
    ...
    private class PlugLineProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PLUGIN_LINE_PROCEDURE));
        }
    ...
    private class PriorityLineProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PRIORITY_LINE_PROCEDURE));
        }
    ...
    private class LinesCountLineProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.LINESCOUNT_LINE_PROCEDURE));
        }
    ...
    private class RevLineLineProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.REVLINE_LINE_PROCEDURE));
        }
    ...
    private class PlugLinesCountLineProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PLUGLINESCOUNT_LINE_PROCEDURE));
        }
    ...
    private class PlugLineLineProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PLUGLINE_LINE_PROCEDURE));
        }
    ...
    private class RevPaneProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.REV_PANE_PROCEDURE));
        }
    ...
    private class PlugPaneProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PLUGIN_PANE_PROCEDURE));
        }
    ...
    private class PriorityPaneProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PRIORITY_PANE_PROCEDURE));
        }
    ...
    private class PanesCountPaneProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PANESCOUNT_PANE_PROCEDURE));
        }
    ...
    private class RevPanePaneProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.REVPANE_PANE_PROCEDURE));
        }
    ...
    private class PlugPanesCountPaneProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PLUGPANESCOUNT_PANE_PROCEDURE));
        }
    ...
    private class PlugPanePaneProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.PLUGPANE_PANE_PROCEDURE));
        }
    ...
    private class ItemStriProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEM_STRI_PROCEDURE));
        }
    ...
    private class TextStriProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.TEXT_STRI_PROCEDURE));
        }
...
//                            new XBL1ToL0StreamConvertor.XBCL1ToL0DefaultStreamConvertor((XBCL1Streamable) new XBL2ToL1StreamConvertor.XBCL2ToL1DefaultStreamConvertor(text)).writeXBStream(output);
    ...
    private class NodePathStriProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.NODEPATH_STRI_PROCEDURE));
        }
...
//                            new XBL1ToL0StreamConvertor.XBCL1ToL0DefaultStreamConvertor((XBCL1Streamable) new XBL2ToL1StreamConvertor.XBCL2ToL1DefaultStreamConvertor(text)).writeXBStream(output);
    ...
    private class ItemStriStriProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEMSTRI_STRI_PROCEDURE));
        }
    ...
    private class ItemStrisStriProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.ITEMSTRIS_STRI_PROCEDURE));
        }
    ...
    private class StrisCountStriProcedure implements XBProcedure {
        ...
        @Override
        public XBBlockType getType() {
            return new XBDBlockType(new XBCPBlockDecl(XBServiceClient.STRISCOUNT_STRI_PROCEDURE));
        }
