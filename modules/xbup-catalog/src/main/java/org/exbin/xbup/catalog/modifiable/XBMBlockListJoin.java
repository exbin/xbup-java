 ...
 */
public interface XBMBlockListJoin extends XBCBlockListJoin, XBMJoinDef {

    /**
     * Sets specification which is also owner.
     *
     * @param spec XBCBlockSpec block specification
     */
    @Override
     ...
     */
    void setTarget(@Nullable XBCBlockRev blockRev);
}
