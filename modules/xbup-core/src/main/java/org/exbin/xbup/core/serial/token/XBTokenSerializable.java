...
public interface XBTokenSerializable extends XBSerializable {
     ...
     */
    void serializeFromXB(XBTokenInputSerialHandler serializationHandler) throws XBProcessingException, IOException;
     ...
     * @throws IOException if input/output problem encountered
     */
    void serializeToXB(XBTokenOutputSerialHandler serializationHandler) throws XBProcessingException, IOException;
}
