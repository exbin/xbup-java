...
public interface XBBasicReceivingSerializable extends XBSerializable {
     ...
     */
    public void serializeRecvFromXB(XBBasicInputReceivingSerialHandler serializationHandler) throws XBProcessingException, IOException;
     ...
     * @throws IOException if input/output problem encountered
     */
    public void serializeRecvToXB(XBBasicOutputReceivingSerialHandler serializationHandler) throws XBProcessingException, IOException;
}
