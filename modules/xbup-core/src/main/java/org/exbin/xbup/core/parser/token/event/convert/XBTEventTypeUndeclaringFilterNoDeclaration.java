 ...
 */
public class XBTEventTypeUndeclaringFilterNoDeclaration implements XBTEventFilter {
    ...
    public XBTEventTypeUndeclaringFilterNoDeclaration(XBCatalog catalog) {
        this(catalog, null);
    }

    public XBTEventTypeUndeclaringFilterNoDeclaration(XBCatalog catalog, XBTEventListener eventListener) {
        this.catalog = catalog;
        currentContext = new XBLevelContext(catalog, catalog.getRootContext(), 0, false);
        this.eventListener = eventListener;
    }

    public XBTEventTypeUndeclaringFilterNoDeclaration(XBContext initialContext) {
        currentContext = new XBLevelContext(catalog, initialContext, 0, false);
    }

    public XBTEventTypeUndeclaringFilterNoDeclaration(XBContext initialContext, XBTEventListener eventListener) {
        this(initialContext);
        this.eventListener = eventListener;
    }
