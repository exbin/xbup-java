...
public class CatalogConnectionPanel extends javax.swing.JPanel implements OptionsPanel {
    ...
    public void loadFromPreferences(Preferences preferences) {
        if (Boolean.valueOf(preferences.get("serviceConnectionAllowed", Boolean.toString(true))).booleanValue() != serviceConnectionCheckBox.isSelected()) {
        ...
        if (Boolean.valueOf(preferences.get("catalogUpdateAllowed", Boolean.toString(true))).booleanValue() != catalogUpdateConnectionCheckBox.isSelected()) {
